			...
			<div className="min-h-screen flex items-center justify-center bg-linear-to-br from-gray-50 to-gray-100 px-4">
				<div className="max-w-md w-full space-y-8">
								...
								<div>
									...
									<div className="mt-1 relative">
										...
										<input
											...
											className="appearance-none block w-full pr-10 pl-3 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-colors"
											placeholder="admin"
										/>
									</div>
								</div>
					...
					<p className="text-center text-xs text-gray-500">
						{new Date().getFullYear()} الإمام زين العابدين. جميع الحقوق محفوظة.
					</p>
				</div>
			</div>
